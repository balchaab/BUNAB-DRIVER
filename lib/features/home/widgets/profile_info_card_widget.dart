              ...
              onToggle: (val) async {
                ...
                if((ridingCount + parcelCount) > 0){
                  ...
                  if(widget.profileController.isOnline == "1"){
                    ...
                    await widget.profileController.getProfileInfo(silent: true);
                    if (!widget.profileController.canGoOnlineWithCurrentWallet) {
                      Get.dialog(
                        AlertDialog(
                          title: Text('wallet_negative_go_online_title'.tr),
                          content: Text('wallet_negative_go_online_message'.tr),
                          actions: [
                            TextButton(
                              onPressed: () => Get.back(),
