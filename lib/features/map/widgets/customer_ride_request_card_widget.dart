...
void _customSnackBar() {
  // 1. Prevent overlapping calls. If it's already open, don't trigger again.
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                'sorry_you_canot_accept_this_trip'.tr,
                  ...
                  children: [
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          // Close safely before navigating
                          if (Get.isSnackbarOpen) {
                            Get.back(); // Safer way to close snackbar in GetX
                          }
