...
Future<void> main() async {
  ...
  try {
    ...
    // This catches cases where the app exists but Firebase.apps.isEmpty 
    // briefly failed due to race conditions in background isolates
